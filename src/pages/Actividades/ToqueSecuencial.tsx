        ...
        <div className="popup">
          <div className="popup-contenido">
            ...
            {tiemposPorRonda.length > 0 && (() => {
              ...
              let color = 'rojo';
              if (porcentajeNum >= 80) color = 'verde';    // 4-5 estrellas = verde
              else if (porcentajeNum >= 60) color = 'amarillo'; // 2-3 estrellas = amarillo
              ...
              return (
                <div className="resumen-juego">
                  ...
                  <p>
                    <div className={`porcentaje ${color}`}>
                      {Math.round(porcentajeNum)}%
                    </div>
                  </p>
                </div>
              );
