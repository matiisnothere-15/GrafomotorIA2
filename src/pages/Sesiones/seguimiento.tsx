          ...
          <div className="alert alert--info" role="status" aria-live="polite">
            <div className="alert__icon" aria-hidden>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
                <path d="M12 9h.01M11 13h1v4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.4" fill="none" />
              </svg>
            </div>
            <div className="alert__content">
              <div className="alert__title">Información</div>
              <div className="alert__message">Seleccione un paciente para ver sus métricas de desempeño por tipo de ejercicio.</div>
            </div>
          </div>
        ) : (
          (
