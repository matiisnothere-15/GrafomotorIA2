...
const Home: React.FC = () => {
  ...
  const [EdadMesPaciente, setEdadMesPaciente] = useState<string>('');
  ...
  const seleccionarPaciente = () => {
    setGlobalPaciente(pacienteSeleccionado, nombrePaciente, EdadMesPaciente);
              ...
              <div className="campo">
                <Select
                  ...
                  onChange={(opcion) => {
                    ...
                    // pasar fecha nacimiento paciente
                    if (opcion?.fecnac) {
                      const fechaNac = new Date(opcion.fecnac);
                      const hoy = new Date();
                      ...
                      const edad_mes = `${años}-${meses}`;
                      setEdadMesPaciente(edad_mes);
                    }
                  }}
